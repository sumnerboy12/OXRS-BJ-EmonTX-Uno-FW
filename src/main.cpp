...
const uint16_t startUpPeriodMs  = 3000;   // to allow LP filter to settle
...
void setup()
{
  ...
  Serial.println();
  Serial.println(F("========================================"));
  Serial.print  (F("FIRMWARE: ")); Serial.println(STRINGIFY(FW_NAME));
  Serial.print  (F("MAKER:    ")); Serial.println(STRINGIFY(FW_MAKER));
  Serial.print  (F("VERSION:  ")); Serial.println(STRINGIFY(FW_VERSION));
  Serial.println(F("========================================"));
